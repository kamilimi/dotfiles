...
map('n', '<leader>t', builtin.find_files, { desc = 'Telescope: find files' })
map('n', '<leader>?', builtin.keymaps, { desc = 'Telescope: keymaps' })
map('n', '<leader>T', builtin.treesitter, { desc = 'Telescope: keymaps' })
